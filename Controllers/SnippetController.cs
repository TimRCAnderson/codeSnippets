...
namespace codeSnippets.Controllers
{
    public class SnippetController : Controller
    {
        ...
        // GET: Snippet
        public async Task<IActionResult> Index(string LanguageSearch, string DescriptionSearch)
        {

            var snippets = from snippet in _context.Snippet select snippet;
            ...
            {
                snippets = snippets.Where(snippet => snippet.Comment.ToLower().Contains(DescriptionSearch.ToLower()));
            }
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,Code,Language,Comment")] Snippet snippet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Title,Code,Language,Comment")] Snippet snippet)
        {
            if (id != snippet.ID)
            {
                return NotFound();
